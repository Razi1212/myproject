  ...
  return (
    <div className="bg-zinc-900 w-screen h-screen">
      <div className="mx-6
         ...
         lg:mx-10 lg:py-10 lg:flex">

        <div className="p-10">
          <img
            src="./myimg.png"
            alt="Portrait of Raziuddin Shah Mohd."
            className="w-20 h-20 object-cover lg:w-max lg:h-max"
          />
        </div>
        ...
        <div className="">
          <Marquee>
            <img
              src="./Images1.jpeg"
              alt="Image 1"
              className="w-32 h-28 object-cover mx-6 rounded-lg md:w-64 md:h-64 lg:w-52 lg:h-52 max-w-full"
              key="img1"
            />
            <img
              src="./Images2.jpeg"
            ...
            <img
              src="./img6.jpeg"
              alt="Image"
              className="w-32 h-28 object-cover mx-6 rounded-lg md:w-64 md:h-64 lg:w-52 lg:h-52 max-w-fullg"
            />
          </Marquee>
        </div>
      </div>
